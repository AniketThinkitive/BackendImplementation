...
import com.studentapp.student_service.feignclient.AddressClient;
...
public class StudentImpl implements StudentService {
    ...
    public StudentImpl(AddressClient addressClient) {
...
//        AddressResponse addressResponse=new AddressResponse();
        Student s1=studentRepo.findById(studId).get();
        Studentresponses studentresponses=  modelMapper.map(s1,Studentresponses.class);


        ResponseEntity<AddressResponse> addressResponseResponseEntity= addressClient.getAddressByStudentId(studId);
